  ...
  _displayProfileImage() {
    ...
    if (_profileImage == null) {
      if (widget.user.profileImageUrl.isEmpty) {
        // No existing profile image. Display placeholder.
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: GestureDetector(
        ...
        child: ListView(
          children: <Widget>[
            _isLoading ? LinearProgressIndicator(backgroundColor: Colors.blue[200], valueColor: AlwaysStoppedAnimation(Colors.blue),)
              : SizedBox.shrink(),
            Padding(
